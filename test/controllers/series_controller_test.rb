...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create serie" do
    assert_difference('Serie.count') do
      post series_url, params: { serie: { cover_page: @serie.cover_page, name: @serie.name } }
    end
  ...
  test "should update serie" do
    patch serie_url(@serie), params: { serie: { cover_page: @serie.cover_page, name: @serie.name } }
